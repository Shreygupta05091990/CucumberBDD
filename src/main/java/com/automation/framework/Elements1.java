...
public class Elements1 {
	...
	public Logger log = Logger.getLogger(Elements1.class);
	...
	public static String getTitle(){
		return Base1.driver.getTitle();
	}
	
	public String getCurrentUrl(){
		return Base1.driver.getCurrentUrl();
	}
	...
	public  static void click(WebElement element){
		Waits1.waitUntil(() ->isDisplayed(element));
		element.click();
	}
	...
	public Alert getAlert() {
		return Base1.driver.switchTo().alert();
	}
	...
	public void scrollToElemet(WebElement element) {
		Waits1.tryJavascript("window.scrollTo(arguments[0],arguments[1])", element.getLocation().x, element.getLocation().y);
	}
	...
	public void scrollIntoView(WebElement element) {
		Waits1.tryJavascript("arguments[0].scrollIntoView()", element);
	}
	...
	public void scrollDownVertically() {
		Waits1.tryJavascript("window.scrollTo(0, document.body.scrollHeight)");
	}
	...
	public void scrollDownByPixel() {
		Waits1.tryJavascript("window.scrollBy(0,1500)");
	}
	...
	public void ZoomInBypercentage() {
		Waits1.tryJavascript("document.body.style.zoom='40%'");
	}

	public void ZoomBy100percentage() {
		Waits1.tryJavascript("document.body.style.zoom='100%'");
	}
